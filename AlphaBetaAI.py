...
class AlphaBetaAI():
    ...
    def choose_move(self, board):
        ...
        for move in moves_list:
            ...
            self.depth -= 1
            # initialize alpha and beta to neg inf and pos inf
            val = self.min_value(board, -math.inf, math.inf)
            self.depth += 1
            if val >= best_val:
                best_val = val
                best_move = move
        ...
        print("AlphaBeta AI recommending move " + str(best_move) + " with value " + str(best_val))
